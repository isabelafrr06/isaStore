      ...
      <div className="footer-container">
        <div className="footer-content">
          <div className="footer-section">
            <h3>IsaStore</h3>
            <p>Electrónicos de alta calidad y accesorios tecnológicos.</p>
          ...
          <div className="footer-section">
            ...
            <div className="contact-info">
              ...
              <p>📞 +506 83047863</p>
              <p>📍 San Antonio de Belen, Heredia, Costa Rica</p>
            </div>
        ...
        <div className="footer-bottom">
          <p>&copy; 2025 IsaStore. Todos los derechos reservados.</p>
