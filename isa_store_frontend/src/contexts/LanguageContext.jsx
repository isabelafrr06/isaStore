...
const translations = {
  es: {
    ...
    shippingMethod1: '📮 Correos de Costa Rica - Envíos a todo el país',
    shippingMethod2: '🚗 Uber Flash - Cotización disponible dentro del GAM (Gran Área Metropolitana)',
    pickupOption: '📍 Recogida en tienda - Belén',
    pickupTitle: 'Recogida en Tienda',
    pickupDescription: 'También puedes venir a recoger tu pedido directamente en nuestra ubicación.',
    ...
    paymentNote: '⚠️ IMPORTANTE: No se envían productos que no se hayan pagado. El pago debe completarse antes del envío.',
    warranty: 'Garantía',
  ...
  en: {
    ...
    shippingMethod1: '📮 Correos de Costa Rica - Shipping nationwide',
    shippingMethod2: '🚗 Uber Flash - Quote available within GAM (Greater Metropolitan Area)',
    pickupOption: '📍 Store Pickup - Belén',
    pickupTitle: 'Store Pickup',
    pickupDescription: 'You can also come pick up your order directly at our location.',
    ...
    paymentMethod3: '💵 Cash',
    paymentNote: '⚠️ IMPORTANT: Products are not shipped until paid. Payment must be completed before shipping.',
    warranty: 'Warranty',
